...
class Greedy2:
    ...
    def labeling(self):
        ...
        for j in self.jobs:
            for t in j.task:
                lista_task.append([j.id, j.release_time, t, j.due_date])
        ...
        while task_i < len_tasks:
            ...
            while k in range(self.m) and task_i < len_tasks and self.jobs[
                lista_task[task_i][0]].release_time <= start_next_batch:
